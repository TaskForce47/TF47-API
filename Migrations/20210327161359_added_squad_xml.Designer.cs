...
namespace TF47_Backend.Migrations
{
    ...
    [Migration("20210327161359_added_squad_xml")]
    partial class added_squad_xml
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.GameServer.AAR.ReplayItem", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.GameServer.Note", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.GameServer.Player", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.ApiKey", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.Changelog", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.Issue", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.IssueGroup", b =>
                {
                    b.Property<long>("IssueGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.IssueItem", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.IssueTag", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.Squad", b =>
                {
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.SquadMember", b =>
                {
            ...
            modelBuilder.Entity("GroupUser", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.Services.Group", null)
                        .WithMany()
            ...
            modelBuilder.Entity("IssueIssueTag", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.Services.IssueTag", null)
                        .WithMany()
                    ...
                    b.HasOne("TF47_Backend.Database.Models.Services.Issue", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlayerWhitelist", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.GameServer.Whitelist", null)
                        .WithMany()
                    ...
                    b.HasOne("TF47_Backend.Database.Models.GameServer.Player", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.GameServer.Chat", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.GameServer.Player", "Player")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.GameServer.Kill", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.GameServer.Player", "Killer")
                    ...
                    b.HasOne("TF47_Backend.Database.Models.GameServer.Player", "Victim")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.GameServer.Note", b =>
                {
                    ...
                    b.HasOne("TF47_Backend.Database.Models.Services.User", "Writer")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.ApiKey", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.Services.User", "Owner")
                        .WithMany("ApiKeys")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.Changelog", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.Services.User", "Author")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.Issue", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.Services.User", "IssueCreator")
                        .WithMany()
                        .HasForeignKey("IssueCreatorUserId")
                        .HasConstraintName("fk_service_issues_service_users_issue_creator_user_id");

                    b.HasOne("TF47_Backend.Database.Models.Services.IssueGroup", "IssueGroup")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.IssueItem", b =>
                {
                    ...
                    b.HasOne("TF47_Backend.Database.Models.Services.Issue", "Issue")
                        .WithMany("IssueItems")
            ...
            modelBuilder.Entity("TF47_Backend.Database.Models.Services.SquadMember", b =>
                {
                    b.HasOne("TF47_Backend.Database.Models.Services.Squad", "Squad")
